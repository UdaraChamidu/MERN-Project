...
app.get('/users', (req, res) => {   /*url, request and response */
    controller.getUsers((req, res, next) => {   /* call the controller function */
        res.send();   /* send the response to client */
    });
});

app.post('/createuser', (req, res) => {   /*url, request and response */
    controller.addUser(req.body, (callback) => {   /* call the controller function */
        res.send();   /* send the response to client */
    });
});

app.post('/updateuser', (req, res) => {   /*url, request and response */
    controller.updateUser(req.body, (callback) => {   /* call the controller function */
        res.send(callback);   /* paa call back because i need to know which data was updated */
    });
});

app.post('/deleteuser', (req, res) => {   /*url, request and response */
    controller.deleteUser(req.body, (callback) => {   /* call the controller function */
        res.send(callback);   /* paa call back because i need to know which data was updated */
    });
});
